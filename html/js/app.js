        ...
        function(data) {
            ...
            if (data.AttachmentData !== null && data.AttachmentData !== undefined) {
                if (data.AttachmentData.length > 0) {
                    ...
                    $(".weapon-attachments-title").html(
                        '<span style="font-weight: bold; letter-spacing: .1vh;">Bu tabanca eklenti içermiyor</span>'
                    );
                }
            } else {
                $(".weapon-attachments-title").html(
    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>Doğum Tarihi: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>Lisanslar: </strong><span>" +
                itemData.info.type +
                "</span></p><p style=\"font-size:11px\"><b>Ağırlık: </b>" + itemData.weight + " | <b>Miktar: </b> " + itemData.amount
            );
        ...
        //    );
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p>" + itemData.info.uses + " sigara kaldı.</p>"
            );
            ...
            $(".item-info-stats").html('<p>Ağırlık: '+((itemData.weight * itemData.amount) / 1000).toFixed(1) +' | Miktar: '+itemData.amount+ '</p>') 
            ...
            $(".item-info-title").html('<p>' + itemData.label + '</p>')
            $(".item-info-description").html('<p>Tür: ' + itemData.info.species + '</p>Ağırlık: ' + itemData.info.lbs + ' lbs</p>Tip: ' + itemData.info.type);
            ...
            $(".item-info-description").html(
                "<p><strong>Sahip Telefon Numarası: </strong><span>" +
                itemData.info.owner.phone +
                "</span></p><p><strong>Varyasyon: </strong><span>" +
                `${itemData.info.variation}` +
                "</span></p><p><strong>Cinsiyet: </strong><span>" +
                `${gender}` +
                "</span></p><p><strong>Sağlık: </strong><span>" +
                itemData.info.health +
                "</span></p><p><strong>Xp/Max: </strong><span>" +
                `${itemData.info.XP} / ${maxExp(itemData.info.level)}` +
                "</span></p><p><strong>Seviye: </strong><span>" +
                itemData.info.level +
                "</span></p><p><strong>Yaş: </strong><span>" +
                callAge(itemData.info.age) +
                "</span></p><p><strong>Açlık: </strong><span>" +
                itemData.info.food +
                "</span></p>" +
                "</span></p><p><strong>Susuzluk: </strong><span>" +
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>kapasite(L): " + itemData.info.liter + "</p>");
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>Soyisim: </strong><span>" +
                itemData.info.lastname +
                "</span></p><p><strong>Vatandaşlık Numarası: </strong><span>" +
                itemData.info.citizenid +
                "</span></p>"
            );
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p>" + itemData.info.uses + " kullanım kaldı.</p>"
            );
            ...
            if (itemData.info.attachments != null) {
                ...
                $(".item-info-description").html(
                    ...
                    itemData.info.serie +
                    "</span></p><p><strong>Mermi Sayısı: </strong><span>" +
                    itemData.info.ammo +
...
function handleDragDrop() {
    $(".item-drag").draggable({
        ...
        start: function(event, ui) {
            ...
            $(".item-slot").css("border", "1px solid rgba(2, 2, 2, 0.1)");
                    ...
                    if (newDataFrom.name.split("_")[0] == "weapon") {
                        if (!Inventory.IsWeaponBlocked(newDataFrom.name)) {
                            ...
                            if (newDataFrom.info.quality < 25) {
                                ...
                                newDataFrom.info.quality > 25 && newDataFrom.info.quality < 50
                            ) {
                                QualityColor = "rgb(51, 72, 98)";
                ...
                if (fromData.name.split("_")[0] == "weapon") {
                    if (!Inventory.IsWeaponBlocked(fromData.name)) {
                        ...
                        if (fromData.info.quality < 25) {
                            ...
                            fromData.info.quality > 25 && fromData.info.quality < 50
                        ) {
                            QualityColor = "rgb(51, 72, 98)";
...
(() => {
    ...
    Inventory.Open = function(data) {
        totalWeight = 0;
        totalWeightOther = 0;
        $("#player-inv-label").html("<i style='color: black; font-style: normal;'>"+" "+data.para+"</i>")
